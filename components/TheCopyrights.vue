<template>
  <div class="copyrights" role="contentinfo">
    <p>
      2023 . <a href="https://lorena.ramonda.me/" itemprop="url" class="copyrights__domain">lorena.ramonda.me</a>
      <span class="copyrights__spoiler">is</span>
      <a v-tooltip.top="'Whoooaaa, SPOILER! 🙀'" href="https://therocket.dev/" itemprop="url" class="copyrights__domain">therocket.dev</a>
      <br />
      <small>
        <i18n-t keypath="site.tecnology" tag="span" scope="global">
          ...
          <template #cms>
            <a href="https://www.storyblok.com/" target="_blank" rel="noopener">Storyblok</a>
          </template>
          <template #host>
